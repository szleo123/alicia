#!/usr/bin/env python3
"""
Grasp Generation - GraspGen (Intel RealSense D405)
...
class GraspGenerationNode:
    ...
    def _run_ros_mode(self):
        ...
        logging.info("Running in ROS mode (Intel RealSense D405).")
        logging.info("")
...
def main():
    parser = argparse.ArgumentParser(description='GraspGen Grasp Generation Node (D405)')
    ...
    logging.info("=" * 60)
    logging.info("GraspGen Grasp Generation Node (Intel RealSense D405)")
    logging.info("=" * 60)
