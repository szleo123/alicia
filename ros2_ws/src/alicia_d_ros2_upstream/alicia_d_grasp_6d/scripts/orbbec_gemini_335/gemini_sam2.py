...
Usage:
    conda activate sam2
    python segmentation_sam2.py [--model tiny|small|base|large]
...
class SAM2SegmentationNode:
    """
    SAM2-based interactive object segmentation.
    ...
    def __init__(self, args):
        ...
        self.window_name = 'SAM2 Segmentation - Click to select object'
    ...
    def _init_ros(self):
        ...
        try:
            rclpy.init()
            self.node = rclpy.create_node('sam2_segmentation_node')
            ...
            logging.info("Subscribing to: /camera/color/image_raw")
    ...
    def _run_bridge_mode(self):
        ...
        logging.info("Running in bridge mode...")
        logging.info("Waiting for RGB images from bridge...")
        logging.info("")
        logging.info("To send images, run the ROS RGB bridge:")
        logging.info("  python ros_rgb_bridge.py")
        logging.info("")
...
def main():
    parser = argparse.ArgumentParser(description='SAM2 Segmentation Node')
    ...
    logging.info("=" * 60)
    logging.info("SAM2 Segmentation Node")
    logging.info("=" * 60)
