"""Setup assistant launch file for Alicia-D with version and gripper type selection."""
...
def launch_setup(context, *args, **kwargs):
    """Setup MoveIt setup assistant launch with versioned config."""
    ...
    # Generate standard setup assistant launch
    sa_nodes = generate_setup_assistant_launch(moveit_config)
    
    return sa_nodes.entities
