"""Static TF publisher for virtual joints with version and gripper type selection."""
...
def launch_setup(context, *args, **kwargs):
    """Setup static virtual joint TF launch with versioned config."""
    ...
    # Generate standard static TF launch
    tf_nodes = generate_static_virtual_joint_tfs_launch(moveit_config)
    
    return tf_nodes.entities
