"""Warehouse database launch file for Alicia-D with version and gripper type selection."""
...
def launch_setup(context, *args, **kwargs):
    """Setup warehouse database launch with versioned config."""
    ...
    # Generate standard warehouse DB launch
    db_nodes = generate_warehouse_db_launch(moveit_config)
    
    return db_nodes.entities
